 ...
 * https://developer.salesforce.com/docs/atlas.en-us.live_agent_rest.meta/live_agent_rest/live_agent_rest_ChatEnd.htm
 * @package App\Model\Api\Sfla\Transaction
 */
class ChatEnd extends \App\Model\Api\Sfla\Transaction
{
    /**
     * Request method
     */
     ...
     * Request path
     */
    const CONVERSATION_URL = '/chat/rest/Chasitor/ChatEnd';
